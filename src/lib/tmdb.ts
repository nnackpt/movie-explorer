...
export const getPopularMovies = (page = 1, language = 'en-US'): Promise<ApiResponse<Movie>> => {
  return fetchFromApi<ApiResponse<Movie>>('/movie/popular', { page: page.toString(), language });
};
